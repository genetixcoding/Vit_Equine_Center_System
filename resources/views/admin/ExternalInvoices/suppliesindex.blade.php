            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-info shadow-primary border-radius-lg pt-4 pb-5">
                        ...
                        <a href="{{ url('Medicalexternalinvoices')}}"><h4 class="text-white text-capitalize pe-2 text-end">Medical Invoices Page</h4></a>
                    </div>
                </div>
                                    ...
                                    <table class="table  text-center  table-striped mb-0">
                                        <tbody class="table  text-center mb-0">
                                            @foreach ($supexternalinvoicesByMonth as $month)
                                                    @php
                                                        $supexternalinvoices = $allsupexternalinvoices->filter(function($item) use ($month) {
                                                    ...
                                                    @if($supexternalinvoices->count())
                                                        ...
                                                        <div class="card-body table-responsive m-2 px-0 pb-2px-0 pb-2 m-2">
                                                            @foreach ($supexternalinvoices as $invoiceitem)
                                                                @php
                                                                    $totalInvoicePrice = 0;
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="card-body py-5">
                                                                                    <form action="{{ url('update-invoice/'.$invoiceitem->id) }}" method="POST" enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        @method('PUT')
                                                                                        <div class="row">
                                                                    ...
                                                                    <tbody class="text-center">
                                                                        ...
                                                                        <tr>
                                                                            <td>{{ $item->item }}
                                                                                ...
                                                                                <a href="{{ url('delete-suppliesinvoice/'.$item->id) }}" class="text-sm text-danger" onclick="return confirm('Are you sure you want to delete this invoice?')"onclick="return confirm('Are you sure you want to delete it ?')">Delete</a>
                                                                            </td>
                                                                            <td>{{ $item->qty }} * {{ $item->price }}
                                                                                <br>Total Price: {{ $item->totalprice }} EGP</td>
                                                                        </tr>
