            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-info shadow-primary border-radius-lg pt-4 pb-5">
                        ...
                        <a href="{{ url('Suppliesinternalinvoices')}}"><h4 class="text-white text-capitalize pe-2 text-end">Supplies Invoices Page </h4></a>
                    </div>
                </div>
                                ...
                                <div class="card-body table-responsive m-2 px-0 pb-2px-0 pb-2">
                                    <table class="table  text-center  table-striped mb-0">
                                        <tbody class="table  text-center mb-0">
                                            @foreach ($medinternalinvoicesByMonth as $month)
                                                    @php
                                                    ...
                                                    @if($medinternalinvoices->count())
                                                        ...
                                                        <div class="card-body table-responsive m-2 px-0 pb-2px-0 pb-2 m-2">
                                                            @foreach ($medinternalinvoices as $invoiceitem)
                                                                @php
                                                                    $totalInvoicePrice = 0;
                                                                    foreach ($invoiceitem->medinternalinvoices as $item) {
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-6 mt-5">
                                                                                                <select class="form-select" required name="supplier_id">
                                                                                                    ...
                                                                                                    <option value="{{ $supplier->id }}" {{ $supplier->id == $invoiceitem->supplier_id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                            </div>
